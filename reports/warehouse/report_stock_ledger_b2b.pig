...
USE ia_sl_join_ii_pd = ia_sl_join_ii_pd_int_b2b;
...
filtered_iwt_join_pd_sl_b2b = filter iwt_join_pd_sl_b2b by (chararray)STRSPLIT(UnixToISO((long)iwt_join_pd_join_source__iwt_join_pd__wh_inventory_transfer_b2b__updated_at), 'T').$0 >= '[:START_DATE:]' and (chararray)STRSPLIT(UnixToISO((long)iwt_join_pd_join_source__iwt_join_pd__wh_inventory_transfer_b2b__updated_at), 'T').$0 <= '[:END_DATE:]' and ('[:PRODUCT_ID:]' == 'ALL' or '[:PRODUCT_ID:]' == iwt_join_pd_join_source__iwt_join_pd__product_detail_b2b_prod__fsn); 
...
raw_op_report_audits_1 = filter ia_sl_join_ii_pd by (chararray)STRSPLIT(UnixToISO((long)ia_join_ii_pd__inventory_audit_log_b2b_prod__updated_at), 'T').$0 < '[:START_DATE:]' and ('[:PRODUCT_ID:]' == 'ALL' or '[:PRODUCT_ID:]' == ia_join_ii_pd__ii_join_pd__product_detail_b2b_prod__fsn);
...
generate flatten(audit.ia_join_ii_pd__ii_join_pd__inventory_item_b2b_prod__warehouse_id), flatten(audit.ia_join_ii_pd__ii_join_pd__inventory_item_b2b_prod__fsn), flatten(audit.ia_join_ii_pd__ii_join_pd__inventory_item_b2b_prod__sku), 
flatten(audit.ia_join_ii_pd__ii_join_pd__product_detail_b2b_prod__cms_vertical),  flatten(audit.ia_join_ii_pd__inventory_audit_log_b2b_prod__quantity);
};
...
raw_op_report_audits_1 = filter ia_sl_join_ii_pd by (chararray)STRSPLIT(UnixToISO((long)ia_join_ii_pd__inventory_audit_log_b2b_prod__updated_at), 'T').$0 <= '[:END_DATE:]' and ('[:PRODUCT_ID:]' == 'ALL' or '[:PRODUCT_ID:]' == ia_join_ii_pd__ii_join_pd__product_detail_b2b_prod__fsn);
raw_op_report_audits_2 = GROUP raw_op_report_audits_1 by ia_join_ii_pd__inventory_audit_log_b2b_prod__inventory_item_id;
raw_op_report_audits_3 = foreach raw_op_report_audits_2 {
A = ORDER raw_op_report_audits_1 by ia_join_ii_pd__inventory_audit_log_b2b_prod__updated_at desc, ia_join_ii_pd__inventory_audit_log_b2b_prod__id desc;
B = LIMIT A 1;
